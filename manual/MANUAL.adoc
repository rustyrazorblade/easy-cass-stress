...
You can find the default log4j config inhttps://github.com/rustyrazorblade/cassandra-easy-stress/blob/main/src/main/resources/log4j2.yaml[`conf`, window="_blank"].  This should be suitable for most use cases.
